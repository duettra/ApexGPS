...
- [Installation & premier lancement](getting-started.md) — permissions, gestes de base, les cinq premières minutes.

## Sur la carte

- [L\'écran carte](map.md) — gestes, boussole, suivi, la barre d\'outils.
- [Partager votre position](share-and-navigate.md) — envoyer votre spot à un ami, recevoir une position partagée, naviguer vers un point.
...
- [Paramètres](settings.md) — chaque option expliquée.

## Aide

- [FAQ & dépannage](faq.md) — questions courantes et quoi faire quand ça ne marche pas.
- [Nouveautés](changelog.md) — ce qui change à chaque version.

---

ApexGPS est un projet loisir inspiré de l\'open source. Retours : [sandwalker.one@proton.me](mailto:sandwalker.one@proton.me).
