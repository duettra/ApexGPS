...
ApexGPS is currently in closed Play Store testing. Ask the developer for a tester invite at [sandwalker.one@proton.me](mailto:sandwalker.one@proton.me), then tap the invite link on your phone → **Become a tester** → install from Play Store.
...
You'll land on the map. The default map style is **OpenTopoMap** — contour lines, elevation shading, hiking paths in red.
...
**Next:** [The map screen →](map.md) · [Share your location →](share-and-navigate.md) · [Settings →](settings.md)
