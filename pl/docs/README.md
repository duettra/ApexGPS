...
- [Instalacja i pierwsze uruchomienie](getting-started.md) — uprawnienia, podstawowe gesty, pierwsze pięć minut.

## Na mapie

- [Ekran mapy](map.md) — gesty, kompas, śledzenie, pasek narzędzi.
- [Udostępnij lokalizację](share-and-navigate.md) — wyślij swoją pozycję znajomemu, odbierz udostępnione lokalizacje, nawiguj do celu.
...
- [Ustawienia](settings.md) — każda opcja opisana.

## Pomoc

- [FAQ i rozwiązywanie problemów](faq.md) — częste pytania i co zrobić, gdy coś nie działa.
- [Historia zmian](changelog.md) — co nowego w każdej wersji.

---

ApexGPS to hobbystyczny projekt inspirowany open source. Opinie: [sandwalker.one@proton.me](mailto:sandwalker.one@proton.me).
